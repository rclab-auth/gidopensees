...
logFile "Example - Plane Frame on Elastic Soil - Pushover Analysis.log"
...
puts "Interval 2 : Static - [expr int(1+500)] steps"
puts "\n----------------\n"
...
test RelativeEnergyIncr 1e-08 100 2
algorithm Newton
analysis Static
...
numberer RCM
constraints Transformation
integrator DisplacementControl 27 1 0.0016
test NormDispIncr 1e-08 500 2
algorithm Newton
analysis Static
