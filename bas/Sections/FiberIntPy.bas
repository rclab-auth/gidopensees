...
ops.section("FiberInt", *FiberIntTag, "-NStrip", *Strips1, *t1, *Strips2, *t2, *Strips3, *t3)
# First subsection
...
ops.fiber(*operation(-Strips2/2*h2+(0.5-Strips1)*h1+(i-1)*h1), 0, *operation(CoreArea1/Strips1), *SelectedCoreMaterial)
*format "%6g%6g%d"
ops.fiber(*operation(-Strips2/2*h2+(0.5-Strips1)*h1+(i-1)*h1), 0, *operation(CoverArea1/Strips1), *SelectedCoverMaterial)
*format "%6g%6g%d"
ops.fiber(*operation(-Strips2/2*h2+(0.5-Strips1)*h1+(i-1)*h1), 0, *operation(SteelArea1/Strips1), *SelectedRBMaterial)
*endfor
...
# Strip *i
*format "%6g%6g%d"
ops.fiber(*operation(-(Strips2/2-0.5)*h2+(i-1)*h2), 0, *operation(Area2/Strips2), *SelectedCoverMaterial)
*format "%6g%6g%d"
ops.fiber(*operation(-(Strips2/2-0.5)*h2+(i-1)*h2), 0, *operation(SteelArea2/Strips2), *SelectedRBMaterial)
*endfor
...
# Strip *i
*format "%6g%6g%d"
ops.fiber(*operation(Strips2/2*h2+0.5*h3+(i-1)*h3), 0, *operation(CoreArea3/Strips3), *SelectedCoreMaterial)
*format "%6g%6g%d"
ops.fiber(*operation(Strips2/2*h2+0.5*h3+(i-1)*h3), 0, *operation(CoverArea3/Strips3), *SelectedCoverMaterial)
*format "%6g%6g%d"
ops.fiber(*operation(Strips2/2*h2+0.5*h3+(i-1)*h3), 0, *operation(SteelArea3/Strips3), *SelectedRBMaterial)
*endfor

*format "%g%d"
ops.Hfiber(0, 0, *HSteelArea, *SelectedRBMaterial)
*endif
