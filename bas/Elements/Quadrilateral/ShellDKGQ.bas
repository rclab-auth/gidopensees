...
*if(strcmp(ElemsMatProp(Element_type:),"ShellDKGQ")==0)
*if(VarCount==1)
# Materials/Sections Definition used by shellDKGQ elements. (Only if the have not already been defined on this model domain)
...
element ShellDKGQ *ElemsNum *ElemsConec *tcl(FindMaterialNumber *ElemsMatProp(Type) )
