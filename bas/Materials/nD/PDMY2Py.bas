*format "%d%d%g%g%g"
ops.nDMaterial("PressureDependMultiYield02", *MaterialID, *ndime, *MatProp(Saturated_soil_mass_density,real), *MatProp(Reference_shear_modulus_Gr,real), *MatProp(Reference_bulk_modulus,real), *\
*format "%g%g%g%g"
